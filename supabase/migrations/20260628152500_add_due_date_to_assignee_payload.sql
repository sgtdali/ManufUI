-- Migration: Add raw due_date to assignee trigger payload for Planner integration
-- Date: 2026-06-28
-- Author: Antigravity
...
BEGIN
  ...
  IF (TG_OP = 'INSERT' AND NEW.assignee_email IS NOT NULL AND NEW.assignee_email <> '') OR
    ...
    -- Power Automate'in kolayca okuyabileceği üst veri paketi (due_date eklendi)

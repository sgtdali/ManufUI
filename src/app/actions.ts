...
const TARGET_20_CELLS = ["Pres Hücresi", "ETM Hücresi", "ROB104 Hücresi", "ROB108 Hücresi", "ROB109 Hücresi", "ROB110-111 Hücresi"];
...
export async function deleteManufAutomation(id: string) {
  ...
  // Wizard ile olusturulmus fonksiyon/trigger/cron varsa kaldir
  try {
...
export async function triggerCronAutomation(id: string) {
  ...
  // Wizard ile olusturulmus fonksiyonlar icin
  if (!functionName) {
